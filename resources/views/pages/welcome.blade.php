    ...
    <div class="container my-8 mx-auto mt-16 flex">
        <div class="w-2/3 mr-6 px-4 py-4 space-y-6">
            ...
            <div class="flex items-center space-x-4">
                <div class="w-1/2">
                    <div class="flex text-florange items-center mb-1">
                        ...
                        <div class="ml-4 text-lg font-semibold hover:underline hover:text-floblue-dark"><a href="https://apivanlife.test/documentation">Documentation</a></div>
                    </div>
                ...
                <div class="w-1/2">
                    <div class="flex text-florange items-center mb-1">
                        ...
                        <div class="ml-4 text-lg font-semibold hover:underline hover:text-floblue-dark"><a href="https://apivanlife.test/services">Services</a></div>
                    </div>
            ...
            <div class="flex items-center space-x-4">
                <div class="w-1/2">
                    <div class="flex text-florange items-center mb-1">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path></svg>
                        <div class="ml-4 text-lg font-semibold hover:underline hover:text-floblue-dark"><a href="https://apivanlife.test/services">More about us</a></div>
                    </div>
                ...
                <div class="w-1/2">
                    <div class="flex text-florange items-center mb-1">
                        ...
                        <div class="ml-4 text-lg font-semibold hover:underline hover:text-floblue-dark"><a href="https://apivanlife.test/services">API</a></div>
                    </div>
        ...
        <div class="w-1/3 border border-gray-300 rounded-md shadow-md px-4 py-4 space-y-2">
            <h2 class="text-lg text-florange font-semibold">{{ __('On this site')}}</h2>
            <ul class="ml-4 text-base space-y-1 lowercase">
                <li class="font-semibold"><a href="#" class="hover:text-florange ">Home</a> - 
                    <span class="ml-1 text-sm font-normal">{{ __('This page') }}</span></li>
                <li class="font-semibold"><a href="#" class="hover:text-florange ">{{ __('Data') }}</a> - 
                    <span class="ml-1 text-sm font-normal">{{ __('Data currently available') }}</span></li>
                <li class="font-semibold"><a href="#" class="hover:text-florange ">{{ __('Documentation') }}</a> - 
                    <span class="ml-1 text-sm font-normal">{{ __('More information') }}</span></li>
                <li class="font-semibold"><a href="#" class="hover:text-florange ">{{ __('API') }}</a> - 
                    <span class="ml-1 text-sm font-normal">{{ __('A programmable interface') }}</span></li>
                    <li class="font-semibold"><a href="#" class="hover:text-florange ">{{ __('Services') }}</a> - 
                        <span class="ml-1 text-sm font-normal">{{ __('The services we use') }}</span></li>
                <li class="font-semibold"><a href="#" class="hover:text-florange ">{{ __('About') }}</a> - 
                    <span class="ml-1 text-sm font-normal">{{ __('Behind the scenes, the team') }}</span></li>
                <li class="font-semibold"><a href="#" class="hover:text-florange ">{{ __('Contact') }}</a> - 
                    <span class="ml-1 text-sm font-normal">{{ __('Contact us for anything') }}</span></li>
            </ul>
        </div>
    </div>
</x-app-layout>