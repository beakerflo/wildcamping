            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="w-1/2">
                    <div class="flex items-center mb-1 TextHeader">
                        ...
                        <div class="ml-4"><a href="#" class="hover:underline hover:text-floblue-dark">{{ __('Services') }}</a></div>
                    </div>
            ...
            <div class="flex items-center space-x-4">
                <div class="w-1/2">
                    <div class="flex items-center mb-1 TextHeader">
                        ...
                        <div class="ml-4"><a href="#" class="hover:underline hover:text-floblue-dark">{{ __('More about us') }}</a></div>
                    </div>
                ...
                <div class="w-1/2">
                    <div class="flex items-center mb-1 TextHeader">
                        ...
                        <div class="ml-4"><a href="#" class="hover:underline hover:text-floblue-dark">API</a></div>
                    </div>
