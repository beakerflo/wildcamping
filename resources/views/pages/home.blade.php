<x-app-layout title="{{ __($title) }}">
        ...
        <div>
            <ul class="flex items-center px-8 mt-4 border-b space-x-4 border-gray-300">
                <li class="font-semibold flex space-x-2 items-center border-b-2 border-transparent hover:border-gray-400 transition ease-in duration-150 pr-4 pb-3">
                    <svg class="w-4 h-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                    <div class="lowercase"><a href="#">{{ __('Sources') }}</a></div>
                </li>
                <li class="font-semibold flex space-x-2 items-center border-b-2 border-florange pr-4 pb-3">
                    <svg class="w-4 h-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    <div class="lowercase"><a href="#">{{ __('Locations') }}</a></div>
                </li>
                <li class="font-semibold flex space-x-2 items-center border-b-2 border-transparent hover:border-gray-400 transition ease-in duration-150 pr-4 pb-3">
                    <svg class="w-4 h-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
                    <div class="lowercase"><a href="#">{{ __('Favorites') }}</a></div>
                </li>
                <li class="font-semibold flex space-x-2 items-center border-b-2 border-transparent hover:border-gray-400 transition ease-in duration-150 pr-4 pb-3">
                    <svg class="w-4 h-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9"></path></svg>
                    <div class="lowercase"><a href="#">{{ __('Visits') }}</a></div>
                </li>
                <li class="font-semibold flex space-x-2 items-center border-b-2 border-transparent hover:border-gray-400 transition ease-in duration-150 pr-4 pb-3">
                    <svg class="w-4 h-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                    <div class="lowercase"><a href="#">{{ __('Images') }}</a></div>
                </li>
              </ul>
        </div>
        ...
        <div class="container my-8 mx-auto mt-16 flex">
            <div class="w-2/3 mr-6">
                <div class="flex justify-between mb-4 items-center">
                    <div class="flex items-center">
                        <svg class="w-5 h-auto mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                        <input type="text" class="rounded border border-gray-300 shadow bg-flowhite text-florange-dark py-1 px-2 w-60 h-8 placeholder-floblue" placeholder="{{ __('Type to search') }}">
                    </div>
                    <button class="text-florange hover:text-floblue px-2 py-1 rounded-md shadow flex space-x-1">
                        <svg class="w-5 h-auto hover:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        <div class="lowercase">{{ __('New') }}</div>
                    </button>
                </div>
                <div class="bg-florange text-flowhite rounded-md rounded-b-none border border-gray-300 font-semibold items-start">
                    <div class="flex justify-between px-4 py-2">
                        ...
                        <div class="w-2/12 lowercase">
                            {{ __('Source') }}
                        </div>
                        <div class="w-5/12 lowercase">
                            {{ __('Name') }}
                        </div>
                ...
                <div class="border border-gray-300 rounded-md rounded-t-none divide-y divide-gray-300">
                    <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
                        <div class="w-3/12 flex space-x-3 items-center">
                            ...
                            <div class="lowercase">Wildkamperen</div>
                        </div>
                        ...
                        <div class="w-1/12 flex items-center">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3 2"><path fill="#ED2939" d="M0 0h3v2H0z"/><path fill="#fff" d="M0 0h2v2H0z"/><path fill="#002395" d="M0 0h1v2H0z"/></svg>
                        </div>
                    ...
                    <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
                        <div class="w-3/12 flex space-x-3 items-center">
                            ...
                            <div class="lowercase">Camping</div>
                        </div>
                        <div class="w-2/12 truncate">
                            Offroadboyz
                        </div>
                        ...
                        <div class="w-1/12 flex items-center">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 390">
            ...
            <div class="w-1/3 border border-gray-300 rounded-md shadow-md p-2">
                <div class="flex justify-end mb-4 items-center space-x-2">
                    ...
                    <button class="text-red-600 hover:text-floblue font-bold py-1">
                        <svg class="w-5 h-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
                    </button>
                    <button class="text-floblack hover:text-florange py-1">
                        <svg class="w-5 h-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                    </button>
                </div>
                <div class="space-y-4">
                    <div class="flex justify-between items-end">
                        <div class="text-xl text-florange font-semibold px-1">Het vieze meertje</div>
                        <div><span class="text-xs">door: </span>Floris van Enter</div>
                    </div>
                    <div>
                       <ul class="flex text-xs lowercase space-x-1 px-1">
                           <li class="px-2 py-1 lowercase border border-florange-dark text-florange rounded-xl">{{ __('Private') }}</li>
                           <li class="px-2 py-1 lowercase border border-gray-300 rounded-xl">{{ __('Lake') }}</li>
                           <li class="px-2 py-1 lowercase border border-gray-300 rounded-xl">{{ __('Forest') }}</li>
                           <li class="px-2 py-1 lowercase border border-gray-300 rounded-xl">{{ __('Quiet') }}</li>
                       </ul>
                    </div>
                    <div>
                        <h3 class="text-florange lowercase p-1">{{ __('Description')}}:</h3>
                        <div class="px-1">
                ...
                <div class="p-2">
                    <a href="#" class="hover:text-florange items-center justify-center tex-sm flex space-x-1">
