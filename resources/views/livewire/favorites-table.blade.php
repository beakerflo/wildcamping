                ...
                @foreach($Records as $Record)
                    <div wire:click.prevent="getRecordDetails({{ $Record->id }})" class="TableRow hover:bg-gray-200 space-x-1">
                        <div class="w-2/12 flex space-x-3 items-center">
                            <x-record-private private="{{ $Record->isPrivate() }}" class="Svg4" />
            ...
            <x-data-table-details>
                <x-slot name="top">
                    <div class="flex space-x-1 items-center">
                        <x-record-private private="{{ $Record->isPrivate() }}" class="Svg5" />
                        <x-record-favorite class="Svg5" favorite="{{ $Record->isFavorite() }}" />
                    </div>
                                ...
                                <ul>
                                    ...
                                    <li class="flex space-x-2">{{ __('Map') }}<br />
                                        <a href="https://www.google.nl/maps/place/{{ $RecordDetails->coordinate->latitude }},{{ $RecordDetails->coordinate->longitude }}" target="_blank">
                                            <svg class="Svg5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92.3 132.3"><path fill="#1a73e8" d="M60.2 2.2C55.8.8 51 0 46.1 0 32 0 19.3 6.4 10.8 16.5l21.8 18.3L60.2 2.2z"/><path fill="#ea4335" d="M10.8 16.5C4.1 24.5 0 34.9 0 46.1c0 8.7 1.7 15.7 4.6 22l28-33.3-21.8-18.3z"/><path fill="#4285f4" d="M46.2 28.5c9.8 0 17.7 7.9 17.7 17.7 0 4.3-1.6 8.3-4.2 11.4 0 0 13.9-16.6 27.5-32.7-5.6-10.8-15.3-19-27-22.7L32.6 34.8c3.3-3.8 8.1-6.3 13.6-6.3"/><path fill="#fbbc04" d="M46.2 63.8c-9.8 0-17.7-7.9-17.7-17.7 0-4.3 1.5-8.3 4.1-11.3l-28 33.3c4.8 10.6 12.8 19.2 21 29.9l34.1-40.5c-3.3 3.9-8.1 6.3-13.5 6.3"/><path fill="#34a853" d="M59.1 109.2c15.4-24.1 33.3-35 33.3-63 0-7.7-1.9-14.9-5.2-21.3L25.6 98c2.6 3.4 5.3 7.3 7.9 11.3 9.4 14.5 6.8 23.1 12.8 23.1s3.4-8.7 12.8-23.2"/></svg>
                                        </a>
                                        ...
                                        <a href="https://www.bing.com/maps?rtp=~pos.{{ $RecordDetails->coordinate->latitude }}_{{ $RecordDetails->coordinate->longitude }}" target="_blank" class="text-green-600">
                                            <svg class="Svg5" viewBox="213 138.2 598 747.6" xmlns="http://www.w3.org/2000/svg"><path d="m435 332 76.2 165.1 112.4 50.7-405.7 213.4 166.3-148v-422.5l-171.2-52.5v628.4l170.2 119.2 427.8-255v-183.7z" fill="#00897b"/></svg>
                                        </a>
                            ...
                            <div class="w-1/2">
                                ...
                                <ul>
                                    ...
                                    @if($RecordDetails->coordinate->address->country->name)<li>
                                        <div class="flex space-x-2 items-center"><div>{{ $RecordDetails->coordinate->address->country->name }}</div> {!! $RecordDetails->getFlagSvg(4) !!}</div></li> @endif
                                </ul>
                                @endif
                            </div>
                        </div>
