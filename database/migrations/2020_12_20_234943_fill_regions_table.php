...
class FillRegionsTable extends Migration
{
    ...
    public function up()
    {
        DB::table('regions')->insertOrIgnore([
            ...
            array('name' => 'Latin America', 'name_nl' => 'Latijns Amerika', 'continent_id' => DB::table('continents')->Where(['iso_code' => 'SA'])->pluck('id')->first()),
            array('name' => 'The Caribbean', 'name_nl' => 'Het Caribisch gebied', 'continent_id' => DB::table('continents')->Where(['iso_code' => 'SA'])->pluck('id')->first()),
